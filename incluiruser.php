...
$sql = "insert into usuarios(nome, email, senha, situacoe_id, niveis_acesso_id)
values('".$_POST['txt_nome']."', '".$_POST['txt_email']."', '".$_POST['txt_senha']."', '".$_POST['txt_situacoe_id']."', '".$_POST['txt_niveis_acesso_id']."')";
