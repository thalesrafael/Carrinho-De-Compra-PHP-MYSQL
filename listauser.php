...
<header> <h2>Gerenciamento de usuários</h2>  </header>
	<br><br>
	<div id="fundo">



<div id="Barrinha"> <a href ="incluiruser.php"><img src='images/incluir.png'> Incluir</a></div>
	<br><br>
...
if(mysqli_num_rows($res) > 0){
	while($row = mysqli_fetch_assoc($res)){
		...
		<td>
		<a href="alteraruser.php?id=<?=$row['id']?>"><img src='images/editar.png'></a>
		<a href="excluiruser.php?id=<?=$row['id']?>"><img src='images/excluir.png'></a>
		</td>
		</tr>
		<?php
